...
TELEMETRY_API = "https://zerotrace-gamma-three.vercel.app/api/stats"
...
def main():
    ...
    print(f"{PURPLE}🌐 Live Admin Web Dashboard:{RESET} https://zerotrace-gamma-three.vercel.app/admin?key={ADMIN_KEY}\n")
